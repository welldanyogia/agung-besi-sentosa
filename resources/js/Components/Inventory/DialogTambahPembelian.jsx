...
export function DialogTambahPembelian({auth, setError, setSuccess, dataSatuan,itemCodes,items,pembelian}) {
    ...
    const [data, setData] = useState({
        ...
        pajak_masukan: "",
        harga_sebelum_pajak:"",
        tanggal_pembelian: formattedToday
    });
